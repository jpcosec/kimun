...
- **No Heavy Lifting**: Python must not perform heavy parsing or graph traversal logic. It delegates to the Clojure Core via `pyo3`.
- **Git as Transport**: Python is solely responsible for Git integration (commit, push, tracking). Clojure does not know about Git.
