...
The Lisp schema language is the projection surface used to define inspectable schema and model contracts that the Rust kernel validates and interprets.
