...
tags:
- system:sldb
- domain:quality.clean-code.rust
...
Rust code linting keeps the canonical core explicit, typed, modular, and free of accidental complexity.
...
- It is a clean-code dimension specialized for the Rust substrate.
