...
The Lisp macro language is the projection surface used to express reusable functional behavior that lowers into kernel-validated plans rather than mutating canonical state directly.
