---
# edge-xxx
id: edge-task-implement-nodes-ready-to-closeout
# active | archived
status: active
# Source node identifier
source: operator-task-implement-nodes-ready-for-testing
# Target node identifier
target: checklist-task-implement-nodes-closeout-ready
