---
# checklist-xxx
id: checklist-task-implement-documents-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-documents-ready-for-closeout
- condition-task-implement-documents-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
