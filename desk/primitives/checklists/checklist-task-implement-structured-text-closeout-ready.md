---
# checklist-xxx
id: checklist-task-implement-structured-text-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-structured-text-ready-for-closeout
- condition-task-implement-structured-text-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
