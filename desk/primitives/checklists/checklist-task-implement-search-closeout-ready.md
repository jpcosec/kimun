---
# checklist-xxx
id: checklist-task-implement-search-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-search-ready-for-closeout
- condition-task-implement-search-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
