---
# checklist-xxx
id: checklist-task-ejecutar-refactor-base-del-núcleo-sldb-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-ejecutar-refactor-base-del-núcleo-sldb-ready-for-closeout
- condition-task-ejecutar-refactor-base-del-núcleo-sldb-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
