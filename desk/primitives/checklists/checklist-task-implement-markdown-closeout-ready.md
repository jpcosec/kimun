---
# checklist-xxx
id: checklist-task-implement-markdown-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-markdown-ready-for-closeout
- condition-task-implement-markdown-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
