---
# checklist-xxx
id: checklist-task-implement-workflows-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-workflows-ready-for-closeout
- condition-task-implement-workflows-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
