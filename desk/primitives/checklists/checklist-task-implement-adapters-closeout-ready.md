---
# checklist-xxx
id: checklist-task-implement-adapters-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-adapters-ready-for-closeout
- condition-task-implement-adapters-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
