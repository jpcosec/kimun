---
# checklist-xxx
id: checklist-task-implement-patterns-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-patterns-ready-for-closeout
- condition-task-implement-patterns-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
