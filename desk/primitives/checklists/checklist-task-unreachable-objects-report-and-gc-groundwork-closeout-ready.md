---
# checklist-xxx
id: checklist-task-unreachable-objects-report-and-gc-groundwork-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-unreachable-objects-report-and-gc-groundwork-ready-for-closeout
- condition-task-unreachable-objects-report-and-gc-groundwork-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
