---
# checklist-xxx
id: checklist-task-implement-composition-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-composition-ready-for-closeout
- condition-task-implement-composition-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
