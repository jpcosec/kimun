---
# checklist-xxx
id: checklist-task-implement-general-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-general-ready-for-closeout
- condition-task-implement-general-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
