---
# checklist-xxx
id: checklist-task-implement-navigation-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-navigation-ready-for-closeout
- condition-task-implement-navigation-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
