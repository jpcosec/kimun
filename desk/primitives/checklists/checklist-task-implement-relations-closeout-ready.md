---
# checklist-xxx
id: checklist-task-implement-relations-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-relations-ready-for-closeout
- condition-task-implement-relations-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
