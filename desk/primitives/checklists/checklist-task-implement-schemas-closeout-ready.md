---
# checklist-xxx
id: checklist-task-implement-schemas-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-schemas-ready-for-closeout
- condition-task-implement-schemas-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
