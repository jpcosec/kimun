---
# checklist-xxx
id: checklist-task-implement-payloads-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-payloads-ready-for-closeout
- condition-task-implement-payloads-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
