---
# checklist-xxx
id: checklist-task-implement-semantic-indexing-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-semantic-indexing-ready-for-closeout
- condition-task-implement-semantic-indexing-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
