---
# checklist-xxx
id: checklist-task-implement-structure-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-structure-ready-for-closeout
- condition-task-implement-structure-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
