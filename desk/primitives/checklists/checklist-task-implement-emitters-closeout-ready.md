---
# checklist-xxx
id: checklist-task-implement-emitters-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-emitters-ready-for-closeout
- condition-task-implement-emitters-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
