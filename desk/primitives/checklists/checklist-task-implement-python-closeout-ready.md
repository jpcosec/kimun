---
# checklist-xxx
id: checklist-task-implement-python-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-python-ready-for-closeout
- condition-task-implement-python-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
