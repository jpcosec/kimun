---
# checklist-xxx
id: checklist-task-implement-anchors-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-anchors-ready-for-closeout
- condition-task-implement-anchors-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
