---
# checklist-xxx
id: checklist-task-implement-addressability-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-addressability-ready-for-closeout
- condition-task-implement-addressability-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
