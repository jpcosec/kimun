---
# checklist-xxx
id: checklist-task-rewrite-the-pre-v2-spec2viz-specs-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-rewrite-the-pre-v2-spec2viz-specs-ready-for-closeout
- condition-task-rewrite-the-pre-v2-spec2viz-specs-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
