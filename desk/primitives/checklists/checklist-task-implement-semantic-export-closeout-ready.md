---
# checklist-xxx
id: checklist-task-implement-semantic-export-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-semantic-export-ready-for-closeout
- condition-task-implement-semantic-export-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
