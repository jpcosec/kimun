---
# checklist-xxx
id: checklist-task-milestone-5b-drifted-reconciliation-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-milestone-5b-drifted-reconciliation-ready-for-closeout
- condition-task-milestone-5b-drifted-reconciliation-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
