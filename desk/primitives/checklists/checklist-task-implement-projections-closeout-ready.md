---
# checklist-xxx
id: checklist-task-implement-projections-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-projections-ready-for-closeout
- condition-task-implement-projections-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
