---
# checklist-xxx
id: checklist-task-implement-materialization-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-materialization-ready-for-closeout
- condition-task-implement-materialization-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
