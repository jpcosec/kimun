---
# checklist-xxx
id: checklist-task-definir-arquitectura-objetivo-modular-de-sldb-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-definir-arquitectura-objetivo-modular-de-sldb-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
