---
# checklist-xxx
id: checklist-task-implement-hashing-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-hashing-ready-for-closeout
- condition-task-implement-hashing-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
