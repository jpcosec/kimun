---
# checklist-xxx
id: checklist-task-node-host-parity-for-the-v2-kernel-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-node-host-parity-for-the-v2-kernel-ready-for-closeout
- condition-task-node-host-parity-for-the-v2-kernel-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
