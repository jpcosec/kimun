---
# checklist-xxx
id: checklist-task-definir-arquitectura-objetivo-modular-de-sldb-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-definir-arquitectura-objetivo-modular-de-sldb-ready-for-closeout
- condition-task-definir-arquitectura-objetivo-modular-de-sldb-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
