---
# checklist-xxx
id: checklist-task-implement-boundary-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-boundary-ready-for-closeout
- condition-task-implement-boundary-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
