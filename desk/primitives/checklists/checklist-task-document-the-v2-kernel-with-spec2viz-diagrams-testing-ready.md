---
# checklist-xxx
id: checklist-task-document-the-v2-kernel-with-spec2viz-diagrams-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-document-the-v2-kernel-with-spec2viz-diagrams-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
