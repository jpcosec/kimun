---
# checklist-xxx
id: checklist-task-implement-retrieval-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-retrieval-ready-for-closeout
- condition-task-implement-retrieval-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
