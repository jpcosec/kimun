---
# checklist-xxx
id: checklist-task-implement-queries-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-queries-ready-for-closeout
- condition-task-implement-queries-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
