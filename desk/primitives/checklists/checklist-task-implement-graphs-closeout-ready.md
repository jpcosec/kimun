---
# checklist-xxx
id: checklist-task-implement-graphs-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-graphs-ready-for-closeout
- condition-task-implement-graphs-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
