---
# checklist-xxx
id: checklist-task-milestone-5a-anchor-states-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-milestone-5a-anchor-states-ready-for-closeout
- condition-task-milestone-5a-anchor-states-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
