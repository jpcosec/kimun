---
# checklist-xxx
id: checklist-task-implement-authoring-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-authoring-ready-for-closeout
- condition-task-implement-authoring-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
