---
# checklist-xxx
id: checklist-task-tighten-semantic-export-provenance-contract-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-tighten-semantic-export-provenance-contract-ready-for-closeout
- condition-task-tighten-semantic-export-provenance-contract-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
