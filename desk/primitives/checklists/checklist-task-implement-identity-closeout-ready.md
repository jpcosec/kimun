---
# checklist-xxx
id: checklist-task-implement-identity-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-identity-ready-for-closeout
- condition-task-implement-identity-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
