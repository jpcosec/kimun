---
# checklist-xxx
id: checklist-task-implement-document-families-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-document-families-ready-for-closeout
- condition-task-implement-document-families-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
