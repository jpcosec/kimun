---
# checklist-xxx
id: checklist-task-implement-importers-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-importers-ready-for-closeout
- condition-task-implement-importers-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
