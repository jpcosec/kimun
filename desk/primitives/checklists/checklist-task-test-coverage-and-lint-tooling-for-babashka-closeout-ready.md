---
# checklist-xxx
id: checklist-task-test-coverage-and-lint-tooling-for-babashka-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-test-coverage-and-lint-tooling-for-babashka-ready-for-closeout
- condition-task-test-coverage-and-lint-tooling-for-babashka-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
