---
# checklist-xxx
id: checklist-task-implement-testing-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-testing-ready-for-closeout
- condition-task-implement-testing-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
