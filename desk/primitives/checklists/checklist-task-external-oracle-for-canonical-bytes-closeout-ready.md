---
# checklist-xxx
id: checklist-task-external-oracle-for-canonical-bytes-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-external-oracle-for-canonical-bytes-ready-for-closeout
- condition-task-external-oracle-for-canonical-bytes-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
