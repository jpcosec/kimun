---
# checklist-xxx
id: checklist-task-implement-provenance-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-provenance-ready-for-closeout
- condition-task-implement-provenance-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
