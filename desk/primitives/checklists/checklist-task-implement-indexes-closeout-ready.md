---
# checklist-xxx
id: checklist-task-implement-indexes-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-indexes-ready-for-closeout
- condition-task-implement-indexes-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
