---
# checklist-xxx
id: checklist-task-contention-test-for-heads-commit-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-contention-test-for-heads-commit-ready-for-closeout
- condition-task-contention-test-for-heads-commit-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
