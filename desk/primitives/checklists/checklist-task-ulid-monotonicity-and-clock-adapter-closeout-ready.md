---
# checklist-xxx
id: checklist-task-ulid-monotonicity-and-clock-adapter-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-ulid-monotonicity-and-clock-adapter-ready-for-closeout
- condition-task-ulid-monotonicity-and-clock-adapter-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
