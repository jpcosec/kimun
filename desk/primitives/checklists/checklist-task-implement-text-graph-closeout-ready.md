---
# checklist-xxx
id: checklist-task-implement-text-graph-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-text-graph-ready-for-closeout
- condition-task-implement-text-graph-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
