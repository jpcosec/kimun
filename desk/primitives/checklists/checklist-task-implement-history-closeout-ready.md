---
# checklist-xxx
id: checklist-task-implement-history-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-history-ready-for-closeout
- condition-task-implement-history-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
