---
# checklist-xxx
id: checklist-task-implement-onboarding-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-onboarding-ready-for-closeout
- condition-task-implement-onboarding-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
