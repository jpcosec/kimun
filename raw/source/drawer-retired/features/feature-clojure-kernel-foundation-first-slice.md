---
id: feature-clojure-kernel-foundation-first-slice
status: proposed
summary: First implementation macrotask for the Clojure-owned canonical kernel, append-only persistence, transaction flow, and kernel API boundary.
tags:
- workspace:desk
- artifact:feature
- system:sldb
...
# Clojure kernel foundation first slice

## Goal

Establish the Clojure-owned canonical kernel and database-backed authority boundary as the first implementation lane.
...
- Clojure kernel + canonical database state is the authority
