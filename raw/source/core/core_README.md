...
El kernel se implementa en Clojure. Lisp funciona como lenguaje de consulta, transformación y extensión.
...
La expresión anterior no muta directamente el grafo. Produce operaciones primitivas que Clojure valida y aplica.

---

### 4. Clojure protege las invariantes

Clojure es responsable de:
...
Clojure garantiza consistencia.
```
...
```text
NodeId persistente ≠ DataScript/Asami::NodeIndex
```
