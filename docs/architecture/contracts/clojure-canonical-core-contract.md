# Clojure Canonical Core Contract

## Purpose and governing sources

This contract defines the technical requirements for the Clojure engine, which serves as the "Canonical Truth" for the SLDB system.
...
The Clojure core is complete for Phase 1 when it can:
