---
# checklist-xxx
id: checklist-task-specify-sldb-target-crates-spec-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-specify-sldb-target-crates-spec-ready-for-closeout
- condition-task-specify-sldb-target-crates-spec-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
