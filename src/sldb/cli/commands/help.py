...
Use `sldb help <topic>` for focused help on: stores, models, docs, fields, sections, ast, find, faq, inbox, explore, legacy.
"""
...
`docs recover` resolves `[[links]]`. `docs compose` expands `![[transclusions]]`.
